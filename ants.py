        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if hasattr(self.ant, 'container') and self.ant.container:
                    ...
                    if hasattr(self.ant, 'name') and self.ant.name == 'Queen' and self.ant.first:
                        return
                else:
                    if hasattr(self.ant, 'name') and self.ant.name == 'Queen' and self.ant.first:
                        return
                ...
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if hasattr(self.ant.ant, 'name') and self.ant.ant.name == 'Queen' and self.ant.ant.first:
                        return
                    self.ant.ant = None
                else:
...
class Ant(Insect):
    ...
    def can_contain(self, other_ant):
        return self.container and self.ant is None and not other_ant.container
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place is not None:
            if place is not hive and len(place.bees) != 0 and position >= self.min_range and position <= self.max_range:
...
class WallAnt(Ant):
    ...
    def __init__(self, armor=4):
        """Create a WallAnt with a larger quantity."""
        Insect.__init__(self, armor)
# The WallAnt class
# END Problem 5A
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 6B
        if len(bee) != 0:
            current_bee = random_or_none(bee)
            current_bee.reduce_armor(current_bee.armor)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        if not QueenAnt.first:
            QueenAnt.first = True
            self.first = True       # true queen
        else:
            self.first = False      # impostor queen
        # END Problem 9
    ...
    def action(self, colony):
        ...
        """
        # BEGIN Problem 9
        if not self.first:          # impostor queen
            ...
            while place.exit != None:
                place = place.exit
                if place.ant != None:
                    if place.ant.container and place.ant.ant != None and not place.ant.ant in QueenAnt.doubled:
                        place.ant.ant.damage *= 2
                        QueenAnt.doubled += [place.ant.ant]
                    if not place.ant in QueenAnt.doubled:
                        place.ant.damage *= 2
                        QueenAnt.doubled += [place.ant]
        # END Problem 9
    ...
    def reduce_armor(self, amount):
        ...
        if self.first and self.armor <= 0:
            bees_win()
        # END Problem 9
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    original_action, new_action = bee.action, effect(bee.action)
